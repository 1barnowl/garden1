"""
market_terminal/enrich/entities.py
...
from market_terminal.config.settings import (
    ENTITY_MAP, MACRO_KEYWORDS, HIGH_TRUST_SOURCES, MED_TRUST_SOURCES, log
)
...
_BEARISH = ["fell", "drop", "declin", "cut", "reduc", "lower",
            "slump", "plunge", "crash", "down"]
_BULLISH = ["rose", "rise", "increas", "gain", "hike", "higher",
            "surged", "jump", "up", "climb"]
