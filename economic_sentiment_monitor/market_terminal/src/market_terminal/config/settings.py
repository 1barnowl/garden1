"""
market_terminal/config/settings.py
...
# ── default config file ───────────────────────────────────────────────────────
DEFAULT_CONFIG = """\
# Economic Sentiment Monitor — runtime config v0.8
...
ENTITY_MAP = {
    ...
    # Macro actors
    "federal reserve": "rates", "the fed": "rates", "fed": "rates",
    "fomc": "rates", "jerome powell": "rates", "powell": "rates",
